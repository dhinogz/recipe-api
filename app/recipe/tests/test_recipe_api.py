...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_return_error(self):
        """Test changing the recipe user returns an eror."""
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        payload = {
            'title': 'Pizza',
            'link': 'https://example.com/pizza-recipe.pdf',
            'description': 'New recipe description',
            'time_minutes': 30,
            'price': Decimal('2.50'),
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'link': 'https://example.com/chicken-noodle.pdf',
            'description': 'New recipe description',
            'time_minutes': 30,
            'price': Decimal('2.50'),
            'ingredients': [{'name': 'Chicken'}, {'name': 'Noodles'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_recipe_assign_ingredient(self):
        ...
        ingredient_noodles = Ingredient.objects.create(
            user=self.user,
            name='Noodles',
        )
        recipe = create_recipe(user=self.user)
        recipe.ingredients.add(ingredient_noodles)
        ...
        self.assertNotIn(ingredient_noodles, recipe.ingredients.all())
